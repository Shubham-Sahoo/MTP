...
# assert(train_data_loader is not None)
# print(train_data_loader._input_dataset)
...
# conformer.predict_step(train_data_loader)

con = 1
# for a in train_data_loader:
#     # print(a[0])
#     # print(a[0]['predictions'])
pred_inf = conformer.predict(train_data_loader, steps=15)
# print(pred_inf)
...
# ground_truth = [seq.decode("utf-8") for seq in ground_truth]       # WER
# hypothesis = [seq.decode("utf-8") for seq in hypothesis]

# ground_truth = [char for seq in ground_truth for char in seq.decode("utf-8")]      # CER
# hypothesis = [char for seq in hypothesis for char in seq.decode("utf-8")]
...
#     seq2 = hpt[i]
#     # print(seq1)
#     for char in seq1.decode("utf-8"):
#         ground_truth.append(char)
    
#     for char2 in seq2.decode("utf-8"):
#         hypothesis.append(char2)
